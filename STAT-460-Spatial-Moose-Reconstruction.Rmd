...
{ 
  pointEstimatesPSO <- cbind(data.frame(N11 = rep(NA, 4), N12 = NA, N13 = NA),data.frame(matrix(NA, nrow = 4, ncol = (Y - 1))),data.frame(C1 = rep(NA, 4), C2 = NA, C3 = NA,S1 = NA, S2 = NA, S3 = NA, VAL = NA))
